    ...
    <nav id="sidebar">
      ...
      <ul class="list-unstyled">
              ...
              <li><a href="home.php"> <i class="icon-padnote"></i>Home</a></li>
                ...
                <li class="active"><a href="become_a_member_page.php"> <i class="icon-padnote"></i>Become a member</a></li>
                <li><a href="about.php"> <i class="icon-padnote"></i>About</a></li>
                <li><a href="contact.php"> <i class="icon-padnote"></i>Contact Us</a></li>  
